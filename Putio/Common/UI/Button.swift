...
class Button: UIButton {
    ...
    func applyVariantStyle() {
        ...
        // UIKit builds the title label, so awakeFromNib never reaches it. The
        // weight is named because a derived one reads regular off the system
        // font's descriptor; medium is the design system's weight for controls.
